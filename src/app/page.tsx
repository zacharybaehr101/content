      ...
      <section style={{ position: 'relative', overflow: 'hidden' }}>
        <div style={{ width: '100%', height: '460px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center' }}>
            <div style={{ paddingLeft: 'max(2rem, calc((100vw - 1200px) / 2 + 2rem))', maxWidth: '780px', width: '65%' }}>
              ...
              <div style={{ fontSize: 'clamp(0.85rem, 1.5vw, 1.1rem)', fontWeight: 500, color: 'rgba(255,255,255,0.75)', marginTop: '0.75rem', marginBottom: '1.75rem', letterSpacing: '0.02em' }}>
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <a href="/pricing" style={{ fontSize: '0.9rem', fontWeight: 600, color: '#fff', padding: '10px 20px', border: '1.5px solid rgba(255,255,255,0.35)', borderRadius: 'var(--radius)', textDecoration: 'none' }}>View pricing</a>
              </div>
            </div>
          </div>
        </div>
